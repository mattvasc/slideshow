...
mockedSlides.addElement(new Element(TypeOfElement.textfield, `<p> Lorem Ipsum </p>`, 43, 30, { 'font-size': '24px', 'font-weight': 'bold', 'color': 'blue'}));
mockedSlides.addElement(new Element(TypeOfElement.image, '<img src="https://picsum.photos/150/150?random">', 43, 60,));
		
export const mockedPresentations: Presentation = new Presentation([], 'Mr.Nice', Visibility.public, 'http://rugbyinafrica.org/2017/08/backgrounds-for-powerpoint/?showimage_zmdh=backgrounds+for+powerpoint.jpg');
mockedPresentations.addSlide(mockedSlides);

export const mockedPresentations2: Presentation = new Presentation([], 'Mr.Nice2', Visibility.public, 'http://rugbyinafrica.org/2017/08/backgrounds-for-powerpoint/?showimage_zmdh=backgrounds+for+powerpoint.jpg');
